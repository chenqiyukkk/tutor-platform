...
export function FilterBar({
  ...
  return (
    ...
    >
      <label>
        <span>地区</span>
        <select defaultValue={values.district ?? ""} name="district">
      ...
      <label>
        <span>科目</span>
        <select defaultValue={values.subject ?? ""} name="subject">
      ...
      {teachers ? (
        <label>
          <span>教师身份</span>
          <select defaultValue={values.identityType ?? ""} name="identityType">
      ...
      <label>
        <span>上课方式</span>
        <select defaultValue={values.mode ?? ""} name="mode">
      ...
      <label>
        <span>预算下限（分/小时）</span>
        <input defaultValue={values.budgetMin} min="0" name="budgetMin" placeholder="如 10000" step="100" type="number" />
      </label>
      <label>
        <span>预算上限（分/小时）</span>
        <input defaultValue={values.budgetMax} min="0" name="budgetMax" placeholder="如 20000" step="100" type="number" />
      </label>
